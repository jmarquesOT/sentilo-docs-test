...
+--------------------------------------+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| sentilo.pending_events_job.batch     | 50                                         | Maximum size (N) of the batch of pending messages to be retrieved and processed from the PEL (pending event list) of each agent in each call. The process runs iteratively in batches of size N until the list is empty |
+--------------------------------------+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| sentilo.pending_events_job.delay     | 30000 (ms)                                 | Waiting time between executions of the job that is responsible for processing pending messages in the PEL of an agent                                                                                                   |
+--------------------------------------+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
